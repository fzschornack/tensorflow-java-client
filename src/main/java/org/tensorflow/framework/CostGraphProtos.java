...
public final class CostGraphProtos {
  ...
  static {
    String[] descriptorData = {
      ...
      "hape.proto\032\013types.proto\"\216\004\n\014CostGraphDef" +
      ...
      "_size\030\006 \001(\003\022\024\n\014compute_cost\030\t \001(\003\022\020\n\010is_" +
      "final\030\007 \001(\010\022\025\n\rcontrol_input\030\010 \003(\005\032;\n\tIn",
      "putInfo\022\026\n\016preceding_node\030\001 \001(\005\022\026\n\016prece" +
      "ding_port\030\002 \001(\005\032\206\001\n\nOutputInfo\022\014\n\004size\030\001" +
      " \001(\003\022\030\n\020alias_input_port\030\002 \001(\003\022+\n\005shape\030" +
      "\003 \001(\0132\034.tensorflow.TensorShapeProto\022#\n\005d" +
      "type\030\004 \001(\0162\024.tensorflow.DataTypeB0\n\030org." +
      "tensorflow.frameworkB\017CostGraphProtosP\001\370" +
      "\001\001b\006proto3"
    };
    ...
    internal_static_tensorflow_CostGraphDef_Node_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_tensorflow_CostGraphDef_Node_descriptor,
        new String[] { "Name", "Device", "Id", "InputInfo", "OutputInfo", "TemporaryMemorySize", "ComputeCost", "IsFinal", "ControlInput", });
    internal_static_tensorflow_CostGraphDef_Node_InputInfo_descriptor =
