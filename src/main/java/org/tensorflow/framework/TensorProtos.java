...
public final class TensorProtos {
  ...
  static {
    String[] descriptorData = {
      ...
      "\020\001\0227\n\023resource_handle_val\030\016 \003(\0132\032.tensor" +
      "flow.ResourceHandleB-\n\030org.tensorflow.fr" +
    ...
    internal_static_tensorflow_TensorProto_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_tensorflow_TensorProto_descriptor,
        new String[] { "Dtype", "TensorShape", "VersionNumber", "TensorContent", "HalfVal", "FloatVal", "DoubleVal", "IntVal", "StringVal", "ScomplexVal", "Int64Val", "BoolVal", "DcomplexVal", "ResourceHandleVal", });
    ResourceHandleProto.getDescriptor();
    org.tensorflow.framework.TensorShapeProtos.getDescriptor();
    org.tensorflow.framework.TypesProtos.getDescriptor();
  }
